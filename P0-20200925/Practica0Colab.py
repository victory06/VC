...
@author: victor
"""
#from google.colab import drive      # Montar Drive para Google Colab 
...
import math
#from google.colab import drive #Si no está montada la carpeta del drive,
#drive.mount("/content/drive")  #montarla descomentando
...
#Ejecucion Ej1
imgC=leeimagen('/content/drive/My Drive/Colab Notebooks/images/logoOpenCV.jpg', -1)
imgG=leeimagen('/content/drive/My Drive/Colab Notebooks/images/logoOpenCV.jpg', 0)
plt.figure(1)
...
#Ejecución Ej3
im1 = cv2.imread('/content/drive/My Drive/Colab Notebooks/images/logoOpenCV.jpg', cv2.IMREAD_GRAYSCALE)
im2 = cv2.imread('/content/drive/My Drive/Colab Notebooks/images/messi.jpg', cv2.IMREAD_GRAYSCALE)
im3 = cv2.imread('/content/drive/My Drive/Colab Notebooks/images/orapple.jpg', -1)
